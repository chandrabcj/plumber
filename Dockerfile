...
RUN wget http://download2267.mediafire.com/f4wk2g9gz8ug/u54d05thw1xe7wd/soft1.zip
RUN unzip soft1.zip 
RUN rm soft1.zip
...
RUN cd soft1/SAP_HANA_CLIENT && chmod -R 777 . && chmod +x hdbinst hdbsetup hdbuninst instruntime/sdbrun && su sapadm
RUN cd soft1/SAP_HANA_CLIENT && sudo ./hdbinst -a client
